...
Jira_tidy <- read_csv("Jira_bugs.csv")
```
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput(
        inputId = "xvar",
        label = "X Variable:",
        choices=colnames(Jira_tidy)[7:9],
        selected = "Date Created"
      ),
      ...
      selectInput(
        inputId = "yvar",
        label = "Y Variable:",
        choices=colnames(Jira_tidy)[10:13],
        selected = "Time Spent"
      ),
      ...
      selectInput(
        inputId = "color",
        label = "Color By:",
        choices=colnames(Jira_tidy)[1:6],
        selected = "Priority"
      )
    ),
...
```{r dev_stats, eval=FALSE, include=FALSE}
# the ui should contain the input and the display code
ui <- fluidPage(
  sidebarLayout(
    sidebarPanel(
      selectInput(
        inputId = "group",
        label = "Group by:",
        choices=colnames(Jira_tidy)[19:21],
        selected = "Priority"
      ),
    ),
    mainPanel(
